...
class DetalleProductorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (id.isEmpty()) {
            Toast.makeText(this, "Error productor vacío", Toast.LENGTH_SHORT).show()
            finish()
            return
        }
        ...
        db.collection("PRODUCTORES")
            ...
            .addOnSuccessListener { doc ->
                ...
                nombre.text = doc.getString("nombre") ?: ""
                ubicacion.text = doc.getString("ubicacion") ?: ""
                telefono.text = doc.getString("telefono") ?: ""
                descripcion.text = doc.getString("descripcion") ?: ""
        ...
        db.collection("PRODUCTOS")
            ...
            .addOnSuccessListener { result ->
                ...
                for (doc in result) {
                    lista.add(doc.toObject(Producto::class.java))
                }
